...
<#
  ...
  Creates a DRAFT post on cms.thebaseo.com from wp-payload-how-to-convert-leads-in-real-estate.json.
  Credentials are read from .env at the project root; nothing is hardcoded.
  Run from anywhere:
    powershell -ExecutionPolicy Bypass -File "articles-in-progress\how-to-convert-leads-in-real-estate\wp-upload-how-to-convert-leads-in-real-estate.ps1"
#>
...
$PayloadFile = Join-Path $ScriptDir "wp-payload-how-to-convert-leads-in-real-estate.json"
