...
$PayloadFile = Join-Path $ScriptDir "wp-payload-short-sale-leads-realtors.json"
...
try {
    ...
    Write-Host "     Recuerda: genera las 3 imagenes desde los prompts [PROMPT FOR CHATGPT IMAGE GENERATION] antes de publicar."
}
catch {
    $code = $null
