...
PAYLOAD_FILE="$SCRIPT_DIR/wp-payload-how-to-start-wholesaling-real-estate.json"
...
case "$HTTP_CODE" in
  201)
    ...
    echo "   Reminder: generate the 4 images from the [PROMPT FOR CHATGPT IMAGE GENERATION] blocks and replace both blocks in the editor before publishing."
    ;;
  401)
