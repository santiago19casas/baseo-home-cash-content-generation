...
# Self-locate: this script lives in articles-in-progress/real-estate-facebook-ads/, project root is two levels up.
SCRIPT_DIR="$(cd "$(dirname "${BASH_SOURCE[0]}")" && pwd)"
PROJECT_ROOT="$(cd "$SCRIPT_DIR/../.." && pwd)"
PAYLOAD_FILE="$SCRIPT_DIR/wp-payload-real-estate-facebook-ads.json"
